 ...
 * 
 * @description
 * This file implements the weekly graphs, including a Line Chart and a Gauge Chart using both Chart.js and ECharts.
 *
 * @version 1.0
*/
...
export default function Main() {
  ...
  return (
    <main>
      ...
      <NavBar />
      <div>
        <h1 className="text-3xl font-bold mb-5 text-center">Reporte Semanal</h1>
      </div>
