      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          <button
            ...
            className="group relative bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-12 px-8 rounded-2xl shadow-xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"
          >
            <div className="flex flex-col items-center space-y-4">
              <div className="bg-white bg-opacity-20 rounded-full p-6 group-hover:bg-opacity-30 transition-all duration-300">
                <svg
                  className="w-12 h-12"
                  fill="none"
                  stroke="currentColor"
          ...
          <button
            ...
            className="group relative bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white font-bold py-12 px-8 rounded-2xl shadow-xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"
          >
            <div className="flex flex-col items-center space-y-4">
              <div className="bg-white bg-opacity-20 rounded-full p-6 group-hover:bg-opacity-30 transition-all duration-300">
                <svg
              ...
              <div className="text-center">
                <h2 className="text-2xl font-bold mb-2">Todos los Reportes</h2>
